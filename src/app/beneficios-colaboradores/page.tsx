...
const beneficios: Beneficio[] = [
  {
    ...
    descricao: 'Oferecemos suporte emocional que ajuda a equilibrar a vida pessoal e profissional, resultando em maior satisfação e bem-estar diário.',
  ...
  {
    titulo: 'Apoio e Recursos Acessíveis',
    descricao: 'Garantimos acesso a atendimento psicológico, palestras, treinamentos e materiais de apoio, assegurando que você saiba onde buscar ajuda.',
  ...
  },
  {
    ...
    descricao: 'Nossos programas reduzem o estresse, a ansiedade e a depressão, promovendo uma vida mais saudável e equilibrada.',
  ...
  {
    titulo: 'Aumento da Resiliência',
    descricao: 'Fortalecemos sua capacidade de enfrentar pressões, mudanças e desafios, desenvolvendo profissionais mais fortes e confiantes.',
    icon: <IconWrapper><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg></IconWrapper>,
  },
  {
    titulo: 'Maior Satisfação no Trabalho',
    descricao: 'Colaboradores emocionalmente saudáveis demonstram maior prazer em suas atividades, elevando o comprometimento.',
  ...
  },
  {
    ...
    descricao: 'Incentivamos o desenvolvimento de habilidades como empatia, inteligência emocional, comunicação assertiva e gestão de conflitos.',
  ...
  {
    titulo: 'Sentimento de Valorização',
    descricao: 'A preocupação genuína da empresa com o bem-estar gera reconhecimento, aumentando o engajamento e a motivação.',
    icon: <IconWrapper><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg></IconWrapper>,
  },
  {
    titulo: 'Equilíbrio Vida Pessoal-Profissional',
    descricao: 'Colaboradores assistidos emocionalmente conseguem gerenciar melhor suas energias, reduzindo a sensação de sobrecarga.',
  ...
  },
  {
    ...
    descricao: 'Ambientes que priorizam a saúde mental impulsionam a liberdade de pensamento, promovendo a criatividade e a inovação.',
  ...
  },
  {
    ...
    descricao: 'Colaboradores equilibrados emocionalmente tomam decisões mais eficazes, minimizando erros e aumentando a eficiência.',
  ...
  {
    titulo: 'Melhora nas Relações Interpessoais',
    descricao: 'Promovemos relações mais saudáveis com colegas, líderes e clientes, otimizando o ambiente de trabalho.',
  ...
  {
    titulo: 'Fortalecimento da Autoconfiança',
    descricao: 'Nossos programas ajudam a reconhecer suas capacidades, aumentando a autoconfiança no desempenho profissional e pessoal.',
  ...
  {
    titulo: 'Redução de Problemas Físicos',
    descricao: 'O cuidado com a saúde mental impacta positivamente a saúde física, diminuindo problemas como insônia e dores musculares.',
      ...
      <section className="section-padding bg-gradient-to-br from-olive-50 via-white to-primary-light/10 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Acreditamos que o bem-estar dos colaboradores é a chave para o sucesso.
              Nossos programas são desenhados para promover uma vida mais equilibrada
              e produtiva.
            </motion.p>
          </div>
        </div>
        ...
        <div className="container-custom">
          ...
          >
            <p className="text-xl leading-relaxed">
              Você merece trabalhar em um ambiente que valoriza seu{' '}
              <span className="text-accent font-bold">bem-estar emocional</span>. Nossos
              programas foram desenvolvidos pensando em você, para que possa viver e
              trabalhar com mais equilíbrio, satisfação e propósito.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10">
              Sua saúde emocional é importante. Se sua empresa ainda não oferece
              nossos programas, entre em contato e descubra como você pode se
