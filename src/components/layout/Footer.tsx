...
const footerLinks = {
  ...
  cursos: [
    { name: 'Cursos Semiguini', href: '/cursos' },
  ],
}
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              >
                ...
                <div className="flex gap-4 pt-2">
                  <a
                    ...
                    className="w-10 h-10 bg-white/10 hover:bg-accent hover:text-primary-dark rounded-full flex items-center justify-center transition-all duration-300"
                  >
            ...
            <div>
              ...
              >
                <h4 className="font-semibold text-accent mb-4">Institucional</h4>
      ...
      <div className="border-t border-white/10 py-6">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
            <p>&copy; {currentYear} Instituto Semiguini. Todos os direitos reservados.</p>
