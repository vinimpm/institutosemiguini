        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-10 md:p-16 relative overflow-hidden">
              ...
              <blockquote className="relative z-10">
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-primary-dark leading-relaxed text-center">
                  "Promover o desenvolvimento integral de pessoas e organizações
                  por meio de soluções humanizadas, estratégicas e eficazes."
                </p>
              </blockquote>
          ...
          >
            {[
              {
                title: 'Humanização',
                description: 'Cada pessoa é única, tratamos todos com respeito e empatia.',
                icon: (
              ...
              {
                title: 'Estratégia',
                description: 'Soluções inteligentes alinhadas aos objetivos organizacionais.',
                icon: (
                  <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {
                title: 'Eficácia',
                description: 'Resultados concretos e transformações duradouras.',
                icon: (
                  <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
