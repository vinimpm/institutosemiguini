    ...
    <section className="relative py-16 lg:py-32 overflow-hidden">
      ...
      <div className="container-custom relative z-10" ref={ref}>
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            Entre em contato conosco e descubra como podemos ajudar sua organizacao
            a alcancar resultados extraordinarios atraves do desenvolvimento humano.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>+18 anos de experiencia</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
              </svg>
              <span>+20 formacoes terapeuticas</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
